    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-scroll">
            <div class="sidebar-top" data-cluster-id="custom">
                <a data-bs-toggle="tooltip" data-bs-placement="right" title="Home"              data-nav="home"      data-ajaxnav="true" href="{{ route('home') }}"      class="sidebar-icon-box{{ ($activeNav ?? '') === 'home'      ? ' active' : '' }}"><div class="sidebar-icon"><svg><use xlink:href="#svg/logo_battlezone"></use></svg></div></a>
                ...
                <a data-bs-toggle="tooltip" data-bs-placement="right" title="Modding Resources" data-nav="modding"   data-ajaxnav="true" href="{{ route('modding') }}"   class="sidebar-icon-box{{ ($activeNav ?? '') === 'modding'   ? ' active' : '' }}"><div class="sidebar-icon"><i class="bi bi-tools"></i></div></a>
