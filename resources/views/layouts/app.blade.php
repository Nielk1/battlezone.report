    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-scroll">
            <div class="sidebar-top" data-cluster-id="custom">
                ...
                <a data-nav="about"     data-ajaxnav="true" href="{{ route('about') }}"     class="sidebar-icon-box{{ ($activeNav ?? '') === 'about'     ? ' active' : '' }}"><div class="sidebar-icon"><i class="bi bi-info-circle-fill"></i></div></a>
            </div>
            {{--
