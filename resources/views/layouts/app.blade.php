    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-scroll">
            <div class="sidebar-top" data-cluster-id="custom">
                <a data-bs-toggle="tooltip" data-bs-placement="right" title="Home"              data-nav="home"      data-ajaxnav="true" href="{{ route('home') }}"      class="sidebar-icon-box{{ ($activeNav ?? '') === 'home'      ? ' active' : '' }}"><div class="sidebar-icon">{!! File::get(resource_path('svg/logo_battlezone.svg')) !!}</div></a>
